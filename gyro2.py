...
while True:
	...
	print "gyroscope_xout: ", ("%5d" % gyroscope_xout), " scalat: ", (gyroscope_xout / 131)
	print "gyroscope_yout: ", ("%5d" % gyroscope_yout), " scalat: ", (gyroscope_yout / 131)
	print "gyroscope_zout: ", ("%5d" % gyroscope_zout), " scalat: ", (gyroscope_zout / 131)
